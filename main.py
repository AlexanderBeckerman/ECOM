...
from loaders.load_users import load_users_from_reviews
...
from loaders.update_restaurant_summary_and_report import update_restaurant_summary_and_report
app = Flask(__name__)
...
def main():
    ...
    with Session() as session:
        load_restaurants(session, RESTAURANTS_FILEPATH, limit=3)
